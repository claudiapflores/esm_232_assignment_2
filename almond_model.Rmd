...
climate_averages_3 <- merge(climate_averages_1,climate_averages_2, by = "year") # Combine climate_averages_loop_1 and climate_averages_loop_2 data frames into one data frame called climate_averages_loop

# Creating a plot of average minimum average temperatures for the second month of each year
ggplot(data = climate_averages_3, 
       aes(x = year , y = avg_tmin_c)) + 
  geom_point(color = "orange") + 
  labs(title = "Average Minimum Temperatures for the Second Month of Each Year",
       x = "Year",
...
ggplot(data = results, 
  ...
  labs(title = "Annual Almond Yield", 
       x = "Year",
       y = "Almond Yield") +
  theme_light()
```
